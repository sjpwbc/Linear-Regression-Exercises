...
# setwd("C:/Users/sarapeters/Desktop/linear_regression")
...
# EXERCISE - SELECT ANOTHER PREDICTOR:
# fit another model, adding income as an additional predictor
...
# EXERCISE - FINDING: 
# The R^2 improved for this new model; however, the metro variable became nonsignificant
...
sat.income.by.percent <- lm(energy ~ metro*income,
                             data=states.data) 
#Show the results
coef(summary(sat.income.by.percent)) # show regression coefficients table
...
# EXERCISE - FINDINGS:
# No, there are not significant differences across the regions; however, the ANOVA shows minimal significance for region.